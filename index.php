...
<head>
  ...
  <body>
    <header>
      <div class="d-flex flex-column flex-md-row align-items-center fixed-top p-3 px-md-4 mb-1 bg-white border-bottom shadow-sm">
        <h5 class="my-0 mr-md-auto font-weight-normal">Ayaflower</h5>
